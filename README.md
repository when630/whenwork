...
- [설계 v2.5](docs/01_설계.md) — 배경·아키텍처·설계 결정(D1~D7)·데이터 모델·마일스톤·UI 확정 사항·구현 현황
...
- 오늘 탭 — 맨 위에 오늘 일정 타임라인, 아래는 프로젝트별 할 일(급한 건 `D+2`·`오늘` 배지로 드러난다). `F` 마감 있는 것만 보기 · `H` 완료 기록(최근 7일, 체크한 항목 + git 커밋)
